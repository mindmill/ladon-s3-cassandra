...
open class FrameController {
    ...
    fun getMenuItems(path: String, repoid: String): List<MenuItem> {
        return arrayListOf(
                MenuItem("overview", path, repoid, "fa fa-dashboard", "Dashboard", "blue"),
                MenuItem("repositories", path, repoid, "fa fa-cloud", "Buckets", "blue"),
                MenuItem("searchid", path, repoid, "fa fa-file", "Files", "blue")
                        .addChild(MenuItem("searchid", path, repoid, "fa fa-file", "Explorer", "blue"))
                        .addChild(MenuItem("debug", path, repoid, "fa fa-file", "Details", "blue")),
                MenuItem("users", path, repoid, "fa fa-user", "Users", "blue"),
                MenuItem("s3", path, repoid, "fa fa-plug", "Endpoints", "blue"),
                MenuItem("system", path, repoid, "fa fa-area-chart", "System", "blue"),
                MenuItem("cassandra", path, repoid, "fa fa-database", "Cassandra", "blue")
        )
    }
