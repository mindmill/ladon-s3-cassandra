...
public class DatabaseImpl implements Database {
    ...
    private void initSession(String password) {
        List<String> nodes = Arrays.asList(config.getNodes().split(","));
        Cluster.Builder cb = Cluster.builder().addContactPoints(nodes.toArray(new String[nodes.size()]))
    ...
    public void init() {
        try {
            ...
            LOGGER.warn("fallback to  default password", e);
            initSession("cassandra");
    ...
    public void initSchema() {
        ...
        context.put("datacenter", config.getDatacenter());
        context.put("replicationfactor", config.getReplicationfactor());
