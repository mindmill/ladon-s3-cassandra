 ...
 */
@Named open class CreateAdminUserTask @Inject constructor(
        val userDetailsManager: LadonUserDetailsManager) : BootstrapTask {
    ...
    override fun run() {
        userDetailsManager.createUser(LadonUser(
                "admin",
                "\$2a\$08\$ATrPV4GkDaNspmqT8Cog7O7ZiVJWVlxczHWaviFERJwa.ZzFAIsxe",
                true,
                setOf("admin", "user")))
    }
